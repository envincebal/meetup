  ...
  render() {
    ...
    return (
      <div className="event">
        ...
        <p className="event-address"><span className="label">Address: </span>{event.venue.address_1 + event.group.state}</p>
        <p className="event-venue"><span className="label">Venue: </span>{event.venue.name}</p>
